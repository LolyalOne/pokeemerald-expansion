const u8 gRibbonDescriptionPart1_Champion[] = _("Venceu o CAMPEAO, membro");
const u8 gRibbonDescriptionPart2_Champion[] = _("do HALL DA FAMA. Incrivel!");
const u8 gRibbonDescriptionPart1_CoolContest[] = _("CONCURSO COOL");
const u8 gRibbonDescriptionPart1_BeautyContest[] = _("CONCURSO BEAUTY");
const u8 gRibbonDescriptionPart1_CuteContest[] = _("CONCURSO CUTE");
const u8 gRibbonDescriptionPart1_SmartContest[] = _("CONCURSO SMART");
const u8 gRibbonDescriptionPart1_ToughContest[] = _("CONCURSO TOUGH");
const u8 gRibbonDescriptionPart2_NormalRank[] = _("Vencedor Rank Normal!");
const u8 gRibbonDescriptionPart2_SuperRank[] = _("Vencedor Rank Super!");
const u8 gRibbonDescriptionPart2_HyperRank[] = _("Vencedor Rank Hyper!");
const u8 gRibbonDescriptionPart2_MasterRank[] = _("Vencedor Rank Master!");
const u8 gRibbonDescriptionPart1_Winning[] = _("Por vencer o LV50");
const u8 gRibbonDescriptionPart2_Winning[] = _("na BATTLE TOWER. Show!");
const u8 gRibbonDescriptionPart1_Victory[] = _("Por vencer o Open Level");
const u8 gRibbonDescriptionPart2_Victory[] = _("na BATTLE TOWER. Show!");
const u8 gRibbonDescriptionPart1_Artist[] = _("RIBBON por ser escolhido");
const u8 gRibbonDescriptionPart2_Artist[] = _("como super modelo de esboco.");
const u8 gRibbonDescriptionPart1_Effort[] = _("RIBBON concedida por");
const u8 gRibbonDescriptionPart2_Effort[] = _("ser um grande trabalhador.");
