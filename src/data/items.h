...
// Medicine
    ...
    [ITEM_BURN_HEAL] =
    {
        .name = ITEM_NAME("Anti Queimadura"),
    #if I_PRICE >= GEN_8
        .price = 200,
    #elif I_PRICE == GEN_7
        .price = 300,
...
// Medicinal Flutes
    ...
    [ITEM_RED_FLUTE] =
    {
        .name = ITEM_NAME("Flauta Vermelha"),
        .price = (I_PRICE >= GEN_7) ? 20 : 200,
        .description = COMPOUND_STRING(
            "A glass flute that\n"
            "snaps Pokemon\n"
...
// Fossils
    ...
    [ITEM_ARMOR_FOSSIL] =
    {
        .name = ITEM_NAME("Fossil Armadura"),
        .price = (I_PRICE >= GEN_7) ? 7000: 1000,
        .description = COMPOUND_STRING(
            "A piece of a\n"
            "prehistoric Poke-\n"
    ...
    [ITEM_JAW_FOSSIL] =
    {
        .name = ITEM_NAME("Fossil Mandibula"),
        .price = (I_PRICE >= GEN_7) ? 7000: 1000,
        .description = COMPOUND_STRING(
            "A piece of a\n"
            "prehistoric Poke-\n"
...
// Colored Orbs
    ...
    [ITEM_RED_ORB] =
    {
        .name = ITEM_NAME("Esfera Vermelha"),
        .price = 0,
