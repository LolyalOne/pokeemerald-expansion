...
static const u8 *const sActionStringTable[] =
{
    ...
    [PARTY_MSG_NO_POKEMON]             = COMPOUND_STRING("Voce nao tem POKeMON."),
...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_SWITCH]          = {COMPOUND_STRING("TROCAR"),          CursorCb_Switch},
    [MENU_CANCEL1]         = {gText_Cancel2,                      CursorCb_Cancel1},
    [MENU_ITEM]            = {COMPOUND_STRING("ITEM"),            CursorCb_Item},
    [MENU_GIVE]            = {gMenuText_Give,                     CursorCb_Give},
    [MENU_TAKE_ITEM]       = {COMPOUND_STRING("PEGAR"),            CursorCb_TakeItem},
    [MENU_MOVE_ITEM]       = {COMPOUND_STRING("MOVER"),            CursorCb_MoveItem},
    [MENU_MAIL]            = {COMPOUND_STRING("CARTA"),            CursorCb_Mail},
    [MENU_TAKE_MAIL]       = {COMPOUND_STRING("PEGAR"),            CursorCb_TakeMail},
    [MENU_READ]            = {COMPOUND_STRING("LER"),            CursorCb_Read},
    [MENU_CANCEL2]         = {gText_Cancel2,                      CursorCb_Cancel2},
    [MENU_SHIFT]           = {COMPOUND_STRING("TROCAR"),           CursorCb_SendMon},
    [MENU_SEND_OUT]        = {COMPOUND_STRING("ENVIAR"),        CursorCb_SendMon},
    [MENU_ENTER]           = {COMPOUND_STRING("ENTRAR"),           CursorCb_Enter},
    [MENU_NO_ENTRY]        = {COMPOUND_STRING("SEM ENTRADA"),        CursorCb_NoEntry},
    ...
    [MENU_LEVEL_UP_MOVES]  = {COMPOUND_STRING("GOLPES LVL"),     CursorCb_ChangeLevelUpMoves},
    [MENU_EGG_MOVES]       = {COMPOUND_STRING("GOLPES OVO"),       CursorCb_ChangeEggMoves},
    [MENU_TM_MOVES]        = {COMPOUND_STRING("GOLPES TM"),        CursorCb_ChangeTMMoves},
    [MENU_TUTOR_MOVES]     = {COMPOUND_STRING("GOLPES TUTOR"),     CursorCb_ChangeTutorMoves},
    [MENU_SUB_MOVES]       = {COMPOUND_STRING("APRENDER GOLPES"),     CursorCb_LearnMovesSubMenu},
    [MENU_CATALOG_BULB]    = {COMPOUND_STRING("Lampada"),      CursorCb_CatalogBulb},
    [MENU_CATALOG_OVEN]    = {COMPOUND_STRING("Micro-ondas"),  CursorCb_CatalogOven},
    [MENU_CATALOG_WASHING] = {COMPOUND_STRING("Maq. Lavar"), CursorCb_CatalogWashing},
    [MENU_CATALOG_FRIDGE]  = {COMPOUND_STRING("Geladeira"),    CursorCb_CatalogFridge},
    [MENU_CATALOG_FAN]     = {COMPOUND_STRING("Ventilador"),    CursorCb_CatalogFan},
    [MENU_CATALOG_MOWER]   = {COMPOUND_STRING("Cortador Grama"),      CursorCb_CatalogMower},
    [MENU_CHANGE_FORM]     = {COMPOUND_STRING("Mudar forma"),     CursorCb_ChangeForm},
    [MENU_CHANGE_ABILITY]  = {COMPOUND_STRING("Mudar Hab."),  CursorCb_ChangeAbility},
};
