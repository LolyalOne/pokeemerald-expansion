...
static const u8 sCreditsText_ExecutiveDirector[]              = _("Diretor Executivo");
static const u8 sCreditsText_Director[]                       = _("Diretor");
static const u8 sCreditsText_ArtDirector[]                    = _("Diretor de Arte");
static const u8 sCreditsText_BattleDirector[]                 = _("Diretor de Batalha");
static const u8 sCreditsText_MainProgrammer[]                 = _("Programador Principal");
static const u8 sCreditsText_BattleSystemPgrms[]              = _("Progs. Sist. de Batalha");
static const u8 sCreditsText_FieldSystemPgrms[]               = _("Prog. Sist. de Campo");
static const u8 sCreditsText_Programmers[]                    = _("Programadores");
static const u8 sCreditsText_MainGraphicDesigner[]            = _("Designer Grafico Principal");
static const u8 sCreditsText_GraphicDesigners[]               = _("Designers Graficos");
static const u8 sCreditsText_PkmnDesigners[]                  = _("Designers de POKeMON");
static const u8 sCreditsText_MusicComposition[]               = _("Composicao Musical");
static const u8 sCreditsText_SoundEffectsAndPkmnVoices[]      = _("Sons e Vozes POKeMON");
static const u8 sCreditsText_GameDesigners[]                  = _("Designers do Jogo");
static const u8 sCreditsText_ScenarioPlot[]                   = _("Enredo do Cenario");
static const u8 sCreditsText_Scenario[]                       = _("Cenario");
static const u8 sCreditsText_ScriptDesigners[]                = _("Designers de Script");
static const u8 sCreditsText_MapDesigners[]                   = _("Designers de Mapa");
static const u8 sCreditsText_MapDataDesigners[]               = _("Designers de Dados de Mapa");
static const u8 sCreditsText_ParametricDesigners[]            = _("Designers Parametricicos");
static const u8 sCreditsText_PokedexText[]                    = _("Texto da POKeDEX");
static const u8 sCreditsText_EnvAndToolPgrms[]                = _("Progs. de Amb. e Ferr.");
static const u8 sCreditsText_NCLProductTesting[]              = _("Testes de Produto NCL");
static const u8 sCreditsText_SpecialThanks[]                  = _("Agradecimentos Especiais");
static const u8 sCreditsText_Coordinators[]                   = _("Coordenadores");
static const u8 sCreditsText_Producers[]                      = _("Produtores");
static const u8 sCreditsText_ExecProducers[]                  = _("Produtores Executivos");
static const u8 sCreditsText_InfoSupervisors[]                = _("Supervisores de Informacao");
static const u8 sCreditsText_TaskManagers[]                   = _("Gerentes de Tarefas");
static const u8 sCreditsText_BrailleCodeCheck[]               = _("Checagem de Codigo Braille");
static const u8 sCreditsText_WorldDirector[]                  = _("Diretor do Mundo");
static const u8 sCreditsText_BattleFrontierData[]             = _("Dados da Battle Frontier");
static const u8 sCreditsText_SupportProgrammers[]             = _("Programadores de Suporte");
static const u8 sCreditsText_Artwork[]                        = _("Arte");
static const u8 sCreditsText_LeadProgrammer[]                 = _("Programador Lider");
static const u8 sCreditsText_LeadGraphicArtist[]              = _("Artista Grafico Lider");
...
static const u8 sCreditsText_PackageAndManual[]               = _("Ilust. de Caixa e Manual");
static const u8 sCreditsText_EnglishVersion[]                 = _("Coord. Versao Inglesa");
static const u8 sCreditsText_Translator[]                     = _("Tradutor");
static const u8 sCreditsText_TextEditor[]                     = _("Editor de Texto");
static const u8 sCreditsText_NCLCoordinator[]                 = _("Coordenador NCL");
static const u8 sCreditsText_GraphicDesigner[]                = _("Designer Grafico");
static const u8 sCreditsText_NOAProductTesting[]              = _("Testes de Produto NOA");
