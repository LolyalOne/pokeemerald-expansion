...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_KARATE_CHOP] =
    {
        .name = COMPOUND_STRING("Golpe Karate"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOUBLE_SLAP] =
    {
        .name = COMPOUND_STRING("Tapa Duplo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COMET_PUNCH] =
    {
        .name = COMPOUND_STRING("Soco Cometa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MEGA_PUNCH] =
    {
        .name = COMPOUND_STRING("Mega Soco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PAY_DAY] =
    {
        .name = COMPOUND_STRING("Dia de Pagam."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FIRE_PUNCH] =
    {
        .name = COMPOUND_STRING("Soco de Fogo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_PUNCH] =
    {
        .name = COMPOUND_STRING("Soco de Gelo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THUNDER_PUNCH] =
    {
        .name = COMPOUND_STRING("Soco Trovao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GUILLOTINE] =
    {
        .name = COMPOUND_STRING("Guilhotina"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAZOR_WIND] =
    {
        .name = COMPOUND_STRING("Vento Cortante"),
    ...
    [MOVE_SWORDS_DANCE] =
    {
        .name = COMPOUND_STRING("Danca Espadas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WING_ATTACK] =
    {
        .name = COMPOUND_STRING("Ataque de Asa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WHIRLWIND] =
    {
        .name = COMPOUND_STRING("Redemoinho"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VINE_WHIP] =
    {
        .name = COMPOUND_STRING("Chicote Cipo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOUBLE_KICK] =
    {
        .name = COMPOUND_STRING("Chute Duplo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MEGA_KICK] =
    {
        .name = COMPOUND_STRING("Mega Chute"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_JUMP_KICK] =
    {
        .name = COMPOUND_STRING("Chute de Pulo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROLLING_KICK] =
    {
        .name = COMPOUND_STRING("Chute Giratorio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SAND_ATTACK] =
    {
        .name = COMPOUND_STRING("Ataque de Areia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HORN_ATTACK] =
    {
        .name = COMPOUND_STRING("Ataque de Chifre"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FURY_ATTACK] =
    {
        .name = COMPOUND_STRING("Ataque Furioso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HORN_DRILL] =
    {
        .name = COMPOUND_STRING("Chifre Broca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TACKLE] =
    {
        .name = COMPOUND_STRING("Investida"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BODY_SLAM] =
    {
        .name = COMPOUND_STRING("Pancada Corp."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TAKE_DOWN] =
    {
        .name = COMPOUND_STRING("Investida Audaz"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOUBLE_EDGE] =
    {
        .name = COMPOUND_STRING("Faca de 2 Gumes"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TAIL_WHIP] =
    {
        .name = COMPOUND_STRING("Chicote Cauda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POISON_STING] =
    {
        .name = COMPOUND_STRING("Farpas Veneno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TWINEEDLE] =
    {
        .name = COMPOUND_STRING("Agulha Dupla"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PIN_MISSILE] =
    {
        .name = COMPOUND_STRING("Misseis Farpas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LEER] =
    {
        .name = COMPOUND_STRING("Olhar Fixo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SUPERSONIC] =
    {
        .name = COMPOUND_STRING("Supersonico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SONIC_BOOM] =
    {
        .name = COMPOUND_STRING("Estrondo Son."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DISABLE] =
    {
        .name = COMPOUND_STRING("Desativar"),
        .description = COMPOUND_STRING(
        #if B_DISABLE_TURNS >= GEN_5
            "Por 4 turnos, impede o\n"
        #elif B_DISABLE_TURNS == GEN_4
            "Por 4-7 turnos, impede o\n"
        #else
            "Por 2-5 turnos, impede o\n"
        #endif
            "uso do ultimo golpe."),
        #if B_UPDATED_MOVE_DATA >= GEN_5
            .accuracy = 100,
    ...
    [MOVE_ACID] =
    {
        ...
        .description = COMPOUND_STRING(
            "Joga um acido corrosivo.\n"
        #if B_UPDATED_MOVE_DATA >= GEN_4
            "Pode baixar a Def. Sp."),
        #else
            "Pode baixar a Defesa."),
        #endif
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_POISON,
    ...
    [MOVE_FLAMETHROWER] =
    {
        .name = COMPOUND_STRING("Lanca-Chamas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WATER_GUN] =
    {
        .name = COMPOUND_STRING("Jato de Agua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYDRO_PUMP] =
    {
        .name = COMPOUND_STRING("Hidro Bomba"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_BEAM] =
    {
        .name = COMPOUND_STRING("Raio de Gelo"),
        .description = COMPOUND_STRING(
            "Ataca o alvo com um\n"
        #if B_USE_FROSTBITE == TRUE
            "raio de gelo e friagem."),
        #else
    ...
    [MOVE_BLIZZARD] =
    {
        .name = COMPOUND_STRING("Ventania Gelo"),
        .description = COMPOUND_STRING(
            "Atinge o alvo com uma\n"
        #if B_USE_FROSTBITE == TRUE
            "tempestade de gelo."),
        #else
    ...
    [MOVE_PSYBEAM] =
    {
        .name = COMPOUND_STRING("Raio Psiquico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BUBBLE_BEAM] =
    {
        .name = COMPOUND_STRING("Raio de Bolhas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AURORA_BEAM] =
    {
        .name = COMPOUND_STRING("Raio Aurora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYPER_BEAM] =
    {
        .name = COMPOUND_STRING("Hiper Raio"),
    ...
    [MOVE_DRILL_PECK] =
    {
        .name = COMPOUND_STRING("Bicada Broca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SUBMISSION] =
    {
        .name = COMPOUND_STRING("Submissao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LOW_KICK] =
    {
        .name = COMPOUND_STRING("Chute Baixo"),
        #if B_UPDATED_MOVE_DATA >= GEN_3
            .description = COMPOUND_STRING(
    ...
    [MOVE_COUNTER] =
    {
        .name = COMPOUND_STRING("Contra-Ataque"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SEISMIC_TOSS] =
    {
        .name = COMPOUND_STRING("Arremesso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LEECH_SEED] =
    {
        .name = COMPOUND_STRING("Semente Sanguessuga"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GROWTH] =
    {
        .name = COMPOUND_STRING("Crescimento"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAZOR_LEAF] =
    {
        .name = COMPOUND_STRING("Folha Navalha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SOLAR_BEAM] =
    {
        .name = COMPOUND_STRING("Raio Solar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POISON_POWDER] =
    {
        .name = COMPOUND_STRING("Po de Veneno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STUN_SPORE] =
    {
        .name = COMPOUND_STRING("Esporo Atord."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SLEEP_POWDER] =
    {
        .name = COMPOUND_STRING("Po do Sono"),
        .description = COMPOUND_STRING(
            "Scatters a powder that may\n"
    ...
    [MOVE_PETAL_DANCE] =
    {
        .name = COMPOUND_STRING("Danca de Petalas"),
        .description = COMPOUND_STRING(
            "A rampage of 2 to 3 turns\n"
            "that confuses the user."),
        #if B_UPDATED_MOVE_DATA >= GEN_5
    ...
    [MOVE_STRING_SHOT] =
    {
        .name = COMPOUND_STRING("Tiro de Fio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_RAGE] =
    {
        .name = COMPOUND_STRING("Furia do Dragao"),
        .description = COMPOUND_STRING(
            "Launches shock waves that\n"
    ...
    [MOVE_FIRE_SPIN] =
    {
        .name = COMPOUND_STRING("Giro de Fogo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THUNDER_SHOCK] =
    {
        .name = COMPOUND_STRING("Choque Trovao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THUNDERBOLT] =
    {
        .name = COMPOUND_STRING("Relampago"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THUNDER_WAVE] =
    {
        .name = COMPOUND_STRING("Onda Trovao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_THROW] =
    {
        .name = COMPOUND_STRING("Lancam. Rocha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NIGHT_SHADE] =
    {
        .name = COMPOUND_STRING("Sombra Noturna"),
        .description = COMPOUND_STRING(
            "Inflicts damage identical\n"
            "to the user's level."),
        .effect = EFFECT_LEVEL_DAMAGE,
    ...
    [MOVE_SCREECH] =
    {
        .name = COMPOUND_STRING("Estridente"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOUBLE_TEAM] =
    {
        .name = COMPOUND_STRING("Equipe Dupla"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RECOVER] =
    {
        .name = COMPOUND_STRING("Recuperar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HARDEN] =
    {
        .name = COMPOUND_STRING("Endurecer"),
        .description = COMPOUND_STRING(
            "Stiffens the body's \n"
    ...
    [MOVE_MINIMIZE] =
    {
        .name = COMPOUND_STRING("Minimizar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SMOKESCREEN] =
    {
        .name = COMPOUND_STRING("Cortina Fumaca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CONFUSE_RAY] =
    {
        .name = COMPOUND_STRING("Raio Confusao"),
        .description = COMPOUND_STRING(
            "A sinister ray that\n"
            "confuses the foe."),
        .effect = EFFECT_CONFUSE,
    ...
    [MOVE_DEFENSE_CURL] =
    {
        .name = COMPOUND_STRING("Defesa Curv."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LIGHT_SCREEN] =
    {
        .name = COMPOUND_STRING("Tela de Luz"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FOCUS_ENERGY] =
    {
        .name = COMPOUND_STRING("Foco Energia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIRROR_MOVE] =
    {
        .name = COMPOUND_STRING("Mov. Espelho"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SELF_DESTRUCT] =
    {
        .name = COMPOUND_STRING("Auto-Destruicao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EGG_BOMB] =
    {
        .name = COMPOUND_STRING("Bomba de Ovo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BONE_CLUB] =
    {
        .name = COMPOUND_STRING("Tacada de Osso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FIRE_BLAST] =
    {
        .name = COMPOUND_STRING("Explosao Fogo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WATERFALL] =
    {
        .name = COMPOUND_STRING("Cachoeira"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SKULL_BASH] =
    {
        .name = COMPOUND_STRING("Pancada Cab."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIKE_CANNON] =
    {
        .name = COMPOUND_STRING("Canhao Espinho"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CONSTRICT] =
    {
        .name = COMPOUND_STRING("Constricao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SOFT_BOILED] =
    {
        .name = COMPOUND_STRING("Ovo Cozido"),
        .description = COMPOUND_STRING(
            "Recovers up to half the\n"
            "user's maximum HP."),
    ...
    [MOVE_GLARE] =
    {
        .name = COMPOUND_STRING("Olhar Fixante"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DREAM_EATER] =
    {
        .name = COMPOUND_STRING("Comedor Sonho"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LEECH_LIFE] =
    {
        .name = COMPOUND_STRING("Sugador Vida"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LOVELY_KISS] =
    {
        .name = COMPOUND_STRING("Beijo Doce"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SKY_ATTACK] =
    {
        .name = COMPOUND_STRING("Ataque do Ceu"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRANSFORM] =
    {
        .name = COMPOUND_STRING("Transformar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DIZZY_PUNCH] =
    {
        .name = COMPOUND_STRING("Soco Confusao"),
        #if B_UPDATED_MOVE_DATA >= GEN_2
            .description = COMPOUND_STRING(
    ...
    [MOVE_PSYWAVE] =
    {
        .name = COMPOUND_STRING("Onda Psiquica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ACID_ARMOR] =
    {
        .name = COMPOUND_STRING("Armadura Acida"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CRABHAMMER] =
    {
        .name = COMPOUND_STRING("Martelo Carang."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FURY_SWIPES] =
    {
        .name = COMPOUND_STRING("Golpes Furiosos"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BONEMERANG] =
    {
        .name = COMPOUND_STRING("Ossomerangue"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_REST] =
    {
        .name = COMPOUND_STRING("Descansar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_SLIDE] =
    {
        .name = COMPOUND_STRING("Desliz. Rocha"),
        #if B_UPDATED_MOVE_DATA >= GEN_2
            .description = COMPOUND_STRING(
    ...
    [MOVE_HYPER_FANG] =
    {
        .name = COMPOUND_STRING("Hiper Presa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CONVERSION] =
    {
        .name = COMPOUND_STRING("Conversao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRI_ATTACK] =
    {
        .name = COMPOUND_STRING("Tri Ataque"),
        #if B_UPDATED_MOVE_DATA >= GEN_2
            .description = COMPOUND_STRING(
    ...
    [MOVE_SUPER_FANG] =
    {
        .name = COMPOUND_STRING("Super Presa"),
        .description = COMPOUND_STRING(
            "Attacks with sharp fangs\n"
    ...
    [MOVE_SUBSTITUTE] =
    {
        .name = COMPOUND_STRING("Substituto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRIPLE_KICK] =
    {
        .name = COMPOUND_STRING("Chute Triplo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIDER_WEB] =
    {
        .name = COMPOUND_STRING("Teia Aranha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIND_READER] =
    {
        .name = COMPOUND_STRING("Ler Mente"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLAME_WHEEL] =
    {
        .name = COMPOUND_STRING("Roda de Fogo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CONVERSION_2] =
    {
        .name = COMPOUND_STRING("Conversao 2"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COTTON_SPORE] =
    {
        .name = COMPOUND_STRING("Esporo Algodao"),
        .description = COMPOUND_STRING(
        #if B_UPDATED_MOVE_DATA >= GEN_6
    ...
    [MOVE_POWDER_SNOW] =
    {
        .name = COMPOUND_STRING("Neve em Po"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MACH_PUNCH] =
    {
        .name = COMPOUND_STRING("Soco Mach"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SCARY_FACE] =
    {
        .name = COMPOUND_STRING("Cara Assust."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BELLY_DRUM] =
    {
        .name = COMPOUND_STRING("Tambor Barriga"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SLUDGE_BOMB] =
    {
        .name = COMPOUND_STRING("Bomba de Lama"),
        .description = COMPOUND_STRING(
            "Sludge is hurled to inflict\n"
            "damage. May also poison."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_MUD_SLAP] =
    {
        .name = COMPOUND_STRING("Tapa de Lama"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ZAP_CANNON] =
    {
        .name = COMPOUND_STRING("Canhao Zap"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DESTINY_BOND] =
    {
        .name = COMPOUND_STRING("Destino Final"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PERISH_SONG] =
    {
        .name = COMPOUND_STRING("Cancao Perecer"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICY_WIND] =
    {
        .name = COMPOUND_STRING("Vento Gelado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BONE_RUSH] =
    {
        .name = COMPOUND_STRING("Ataque de Osso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LOCK_ON] =
    {
        .name = COMPOUND_STRING("Travar Mira"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SANDSTORM] =
    {
        .name = COMPOUND_STRING("Tempestade Areia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GIGA_DRAIN] =
    {
        .name = COMPOUND_STRING("Giga Dreno"),
        .description = COMPOUND_STRING(
            "An attack that steals half\n"
            "the damage inflicted."),
        .effect = EFFECT_ABSORB,
    ...
    [MOVE_FALSE_SWIPE] =
    {
        .name = COMPOUND_STRING("Falsa Batida"),
    ...
    [MOVE_SWAGGER] =
    {
        .name = COMPOUND_STRING("Presuncao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MILK_DRINK] =
    {
        .name = COMPOUND_STRING("Beber Leite"),
        .description = COMPOUND_STRING(
            "Recovers up to half the\n"
            "user's maximum HP."),
        .effect = EFFECT_SOFTBOILED,
    ...
    [MOVE_FURY_CUTTER] =
    {
        .name = COMPOUND_STRING("Corte Furioso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STEEL_WING] =
    {
        .name = COMPOUND_STRING("Asa de Aco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MEAN_LOOK] =
    {
        .name = COMPOUND_STRING("Olhar Malvado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SLEEP_TALK] =
    {
        .name = COMPOUND_STRING("Soniloquio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEAL_BELL] =
    {
        .name = COMPOUND_STRING("Sino de Cura"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FRUSTRATION] =
    {
        .name = COMPOUND_STRING("Frustracao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SAFEGUARD] =
    {
        .name = COMPOUND_STRING("Salvaguarda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PAIN_SPLIT] =
    {
        .name = COMPOUND_STRING("Dividir Dor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SACRED_FIRE] =
    {
        .name = COMPOUND_STRING("Fogo Sagrado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DYNAMIC_PUNCH] =
    {
        .name = COMPOUND_STRING("Soco Dinamico"),
        .description = COMPOUND_STRING(
            "Powerful and sure to cause\n"
    ...
    [MOVE_MEGAHORN] =
    {
        .name = COMPOUND_STRING("Megachifre"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_BREATH] =
    {
        .name = COMPOUND_STRING("Sopro do Dragao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ENCORE] =
    {
        .name = COMPOUND_STRING("Repeticao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PURSUIT] =
    {
        .name = COMPOUND_STRING("Perseguicao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAPID_SPIN] =
    {
        .name = COMPOUND_STRING("Giro Rapido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SWEET_SCENT] =
    {
        .name = COMPOUND_STRING("Doce Aroma"),
        .description = COMPOUND_STRING(
        #if B_UPDATED_MOVE_DATA >= GEN_6
    ...
    [MOVE_IRON_TAIL] =
    {
        .name = COMPOUND_STRING("Cauda de Ferro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_METAL_CLAW] =
    {
        .name = COMPOUND_STRING("Garra de Metal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VITAL_THROW] =
    {
        .name = COMPOUND_STRING("Vitalidade"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MORNING_SUN] =
    {
        .name = COMPOUND_STRING("Sol da Manha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CROSS_CHOP] =
    {
        .name = COMPOUND_STRING("Golpe Cruzado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAIN_DANCE] =
    {
        .name = COMPOUND_STRING("Danca da Chuva"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SUNNY_DAY] =
    {
        .name = COMPOUND_STRING("Dia de Sol"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIRROR_COAT] =
    {
        .name = COMPOUND_STRING("Contra-Espelho"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYCH_UP] =
    {
        .name = COMPOUND_STRING("Psico-Foco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ANCIENT_POWER] =
    {
        .name = COMPOUND_STRING("Poder Antigo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHADOW_BALL] =
    {
        .name = COMPOUND_STRING("Bola Sombria"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FUTURE_SIGHT] =
    {
        .name = COMPOUND_STRING("Visao Futura"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_SMASH] =
    {
        .name = COMPOUND_STRING("Quebrar Rocha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BEAT_UP] =
    {
        .name = COMPOUND_STRING("Espancamento"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FAKE_OUT] =
    {
        .name = COMPOUND_STRING("Finta Inicial"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEAT_WAVE] =
    {
        .name = COMPOUND_STRING("Onda de Calor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLATTER] =
    {
        .name = COMPOUND_STRING("Bajulacao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WILL_O_WISP] =
    {
        .name = COMPOUND_STRING("Fogo Fatuo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MEMENTO] =
    {
        .name = COMPOUND_STRING("Recordacao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FOCUS_PUNCH] =
    {
        .name = COMPOUND_STRING("Soco Focado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SMELLING_SALTS] =
    {
        .name = COMPOUND_STRING("Sais de Cheiro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NATURE_POWER] =
    {
        .name = COMPOUND_STRING("Poder Natureza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TAUNT] =
    {
        .name = COMPOUND_STRING("Provocacao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ASSIST] =
    {
        .name = COMPOUND_STRING("Assistencia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SUPERPOWER] =
    {
        .name = COMPOUND_STRING("Superpoder"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGIC_COAT] =
    {
        .name = COMPOUND_STRING("Capa Magica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BRICK_BREAK] =
    {
        .name = COMPOUND_STRING("Quebra-Tijolo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SKILL_SWAP] =
    {
        .name = COMPOUND_STRING("Troca-Mestra"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_REFRESH] =
    {
        .name = COMPOUND_STRING("Refrescar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SNATCH] =
    {
        .name = COMPOUND_STRING("Arrebatar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CAMOUFLAGE] =
    {
        .name = COMPOUND_STRING("Camuflagem"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TAIL_GLOW] =
    {
        .name = COMPOUND_STRING("Brilho Cauda"),
        .description = COMPOUND_STRING(
        #if B_UPDATED_MOVE_DATA >= GEN_5
    ...
    [MOVE_LUSTER_PURGE] =
    {
        .name = COMPOUND_STRING("Purga de Luz"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIST_BALL] =
    {
        .name = COMPOUND_STRING("Bola de Nevoa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FEATHER_DANCE] =
    {
        .name = COMPOUND_STRING("Danca de Penas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TEETER_DANCE] =
    {
        .name = COMPOUND_STRING("Danca Confusa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLAZE_KICK] =
    {
        .name = COMPOUND_STRING("Chute de Fogo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MUD_SPORT] =
    {
        .name = COMPOUND_STRING("Esporte de Lama"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_BALL] =
    {
        .name = COMPOUND_STRING("Bola de Gelo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NEEDLE_ARM] =
    {
        .name = COMPOUND_STRING("Braco de Agulha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYPER_VOICE] =
    {
        .name = COMPOUND_STRING("Voz Hiper"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POISON_FANG] =
    {
        .name = COMPOUND_STRING("Presa Veneno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CRUSH_CLAW] =
    {
        .name = COMPOUND_STRING("Garra Esmagadora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLAST_BURN] =
    {
        .name = COMPOUND_STRING("Explosao de Fogo"),
        .description = COMPOUND_STRING(
            "Powerful, but leaves the\n"
            "user immobile the next turn."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_HYDRO_CANNON] =
    {
        .name = COMPOUND_STRING("Hidro-Canhao"),
        .description = COMPOUND_STRING(
            "Powerful, but leaves the\n"
            "user immobile the next turn."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_ASTONISH] =
    {
        .name = COMPOUND_STRING("Assombrar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WEATHER_BALL] =
    {
        .name = COMPOUND_STRING("Bola de Clima"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FAKE_TEARS] =
    {
        .name = COMPOUND_STRING("Choro Falso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AIR_CUTTER] =
    {
        .name = COMPOUND_STRING("Cortador de Ar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_OVERHEAT] =
    {
        .name = COMPOUND_STRING("Superaquecer"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_TOMB] =
    {
        .name = COMPOUND_STRING("Tumba de Rocha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SILVER_WIND] =
    {
        .name = COMPOUND_STRING("Vento de Prata"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_METAL_SOUND] =
    {
        .name = COMPOUND_STRING("Som de Metal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GRASS_WHISTLE] =
    {
        .name = COMPOUND_STRING("Apito de Grama"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COSMIC_POWER] =
    {
        .name = COMPOUND_STRING("Poder Cosmico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WATER_SPOUT] =
    {
        .name = COMPOUND_STRING("Jorro de Agua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SIGNAL_BEAM] =
    {
        .name = COMPOUND_STRING("Raio de Sinal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHADOW_PUNCH] =
    {
        .name = COMPOUND_STRING("Soco Sombrio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EXTRASENSORY] =
    {
        .name = COMPOUND_STRING("Extrassensorial"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SKY_UPPERCUT] =
    {
        .name = COMPOUND_STRING("Gancho do Ceu"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SAND_TOMB] =
    {
        .name = COMPOUND_STRING("Tumba de Areia"),
        .description = COMPOUND_STRING(
            "Traps and hurts the foe in\n"
    ...
    [MOVE_SHEER_COLD] =
    {
        .name = COMPOUND_STRING("Frio Absoluto"),
        .description = COMPOUND_STRING(
            "A chilling attack that\n"
    ...
    [MOVE_MUDDY_WATER] =
    {
        .name = COMPOUND_STRING("Lama de Agua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BULLET_SEED] =
    {
        .name = COMPOUND_STRING("Semente Bala"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AERIAL_ACE] =
    {
        .name = COMPOUND_STRING("Golpe Aereo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICICLE_SPEAR] =
    {
        .name = COMPOUND_STRING("Lanca de Gelo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_IRON_DEFENSE] =
    {
        .name = COMPOUND_STRING("Defesa de Ferro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_CLAW] =
    {
        .name = COMPOUND_STRING("Garra do Dragao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FRENZY_PLANT] =
    {
        .name = COMPOUND_STRING("Planta Frenesi"),
        .description = COMPOUND_STRING(
            "Powerful, but leaves the\n"
            "user immobile the next turn."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_BULK_UP] =
    {
        .name = COMPOUND_STRING("Musculacao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MUD_SHOT] =
    {
        .name = COMPOUND_STRING("Tiro de Lama"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POISON_TAIL] =
    {
        .name = COMPOUND_STRING("Cauda de Veneno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VOLT_TACKLE] =
    {
        .name = COMPOUND_STRING("Tackle de Volt"),
        #if B_UPDATED_MOVE_DATA >= GEN_4
        .description = COMPOUND_STRING(
            "A life-risking tackle that\n"
    ...
    [MOVE_MAGICAL_LEAF] =
    {
        .name = COMPOUND_STRING("Folha Magica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WATER_SPORT] =
    {
        .name = COMPOUND_STRING("Esporte de Agua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CALM_MIND] =
    {
        .name = COMPOUND_STRING("Mente Calma"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LEAF_BLADE] =
    {
        .name = COMPOUND_STRING("Folha de Corte"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_DANCE] =
    {
        .name = COMPOUND_STRING("Danca do Dragao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_BLAST] =
    {
        .name = COMPOUND_STRING("Rajada de Rocha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHOCK_WAVE] =
    {
        .name = COMPOUND_STRING("Onda de Choque"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WATER_PULSE] =
    {
        .name = COMPOUND_STRING("Pulso de Agua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOOM_DESIRE] =
    {
        .name = COMPOUND_STRING("Desejo do Caos"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYCHO_BOOST] =
    {
        .name = COMPOUND_STRING("Impulso Psico"),
        .description = COMPOUND_STRING(
            "Allows a full-power attack,\n"
            "but sharply lowers Sp. Atk."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_GRAVITY] =
    {
        .name = COMPOUND_STRING("Gravidade"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIRACLE_EYE] =
    {
        .name = COMPOUND_STRING("Olhar Milagre"),
        .description = COMPOUND_STRING(
            "Negate evasiveness and\n"
    ...
    [MOVE_WAKE_UP_SLAP] =
    {
        .name = COMPOUND_STRING("Tapa Acorda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HAMMER_ARM] =
    {
        .name = COMPOUND_STRING("Braco-Martelo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GYRO_BALL] =
    {
        .name = COMPOUND_STRING("Bola Giro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEALING_WISH] =
    {
        .name = COMPOUND_STRING("Desejo de Cura"),
    ...
    [MOVE_NATURAL_GIFT] =
    {
        .name = COMPOUND_STRING("Dom Natural"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TAILWIND] =
    {
        .name = COMPOUND_STRING("Vento de Cauda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ACUPRESSURE] =
    {
        .name = COMPOUND_STRING("Acupressao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_METAL_BURST] =
    {
        .name = COMPOUND_STRING("Explosao Metal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_U_TURN] =
    {
        .name = COMPOUND_STRING("Ida e Volta"),
    ...
    [MOVE_CLOSE_COMBAT] =
    {
        .name = COMPOUND_STRING("Combate Fechado"),
    ...
    [MOVE_PSYCHO_SHIFT] =
    {
        .name = COMPOUND_STRING("Troca Psiquica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEAL_BLOCK] =
    {
        .name = COMPOUND_STRING("Bloqueio Cura"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_TRICK] =
    {
        .name = COMPOUND_STRING("Truque de Forca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GASTRO_ACID] =
    {
        .name = COMPOUND_STRING("Acido Gastrico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LUCKY_CHANT] =
    {
        .name = COMPOUND_STRING("Canto da Sorte"),
        .description = COMPOUND_STRING(
            "Prevents the foe from\n"
    ...
    [MOVE_ME_FIRST] =
    {
        .name = COMPOUND_STRING("Eu Primeiro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_SWAP] =
    {
        .name = COMPOUND_STRING("Troca de Forca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GUARD_SWAP] =
    {
        .name = COMPOUND_STRING("Troca de Guarda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LAST_RESORT] =
    {
        .name = COMPOUND_STRING("Ultimo Recurso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WORRY_SEED] =
    {
        .name = COMPOUND_STRING("Semente Insone"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SUCKER_PUNCH] =
    {
        .name = COMPOUND_STRING("Golpe Baixo"),
    ...
    [MOVE_TOXIC_SPIKES] =
    {
        .name = COMPOUND_STRING("Espinhos Tox."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEART_SWAP] =
    {
        .name = COMPOUND_STRING("Troca de Coracao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AQUA_RING] =
    {
        .name = COMPOUND_STRING("Anel de Agua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGNET_RISE] =
    {
        .name = COMPOUND_STRING("Magnetismo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLARE_BLITZ] =
    {
        .name = COMPOUND_STRING("Bombardeio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FORCE_PALM] =
    {
        .name = COMPOUND_STRING("Palma da Forca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AURA_SPHERE] =
    {
        .name = COMPOUND_STRING("Esfera de Aura"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_POLISH] =
    {
        .name = COMPOUND_STRING("Polir Rocha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POISON_JAB] =
    {
        .name = COMPOUND_STRING("Golpe Veneno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DARK_PULSE] =
    {
        .name = COMPOUND_STRING("Pulso Sombrio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NIGHT_SLASH] =
    {
        .name = COMPOUND_STRING("Corte Noturno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AQUA_TAIL] =
    {
        .name = COMPOUND_STRING("Cauda de Agua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SEED_BOMB] =
    {
        .name = COMPOUND_STRING("Bomba de Semente"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AIR_SLASH] =
    {
        .name = COMPOUND_STRING("Corte de Ar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_X_SCISSOR] =
    {
        .name = COMPOUND_STRING("Tesoura X"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_PULSE] =
    {
        .name = COMPOUND_STRING("Pulso do Dragao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_RUSH] =
    {
        .name = COMPOUND_STRING("Investida Dragao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_GEM] =
    {
        .name = COMPOUND_STRING("Poder da Gema"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAIN_PUNCH] =
    {
        .name = COMPOUND_STRING("Soco Dreno"),
        .description = sMegaDrainDescription,
        .effect = EFFECT_ABSORB,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 75 : 60,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_FOCUS_BLAST] =
    {
        .name = COMPOUND_STRING("Foco Explosivo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ENERGY_BALL] =
    {
        .name = COMPOUND_STRING("Bola de Energia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BRAVE_BIRD] =
    {
        .name = COMPOUND_STRING("Bravo Passaro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EARTH_POWER] =
    {
        .name = COMPOUND_STRING("Poder da Terra"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SWITCHEROO] =
    {
        .name = COMPOUND_STRING("Troca-Troca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NASTY_PLOT] =
    {
        .name = COMPOUND_STRING("Maquinacao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BULLET_PUNCH] =
    {
        .name = COMPOUND_STRING("Soco Bala"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_SHARD] =
    {
        .name = COMPOUND_STRING("Estilhaco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHADOW_CLAW] =
    {
        .name = COMPOUND_STRING("Garra Sombria"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THUNDER_FANG] =
    {
        .name = COMPOUND_STRING("Presa Trovao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_FANG] =
    {
        .name = COMPOUND_STRING("Presa de Gelo"),
        .description = COMPOUND_STRING(
            "May cause flinching or\n"
        #if B_USE_FROSTBITE == TRUE
            "pode causar friagem."),
    ...
    [MOVE_FIRE_FANG] =
    {
        .name = COMPOUND_STRING("Presa de Fogo"),
        .description = COMPOUND_STRING(
            "May cause flinching or\n"
    ...
    [MOVE_SHADOW_SNEAK] =
    {
        .name = COMPOUND_STRING("Sombra Furtiva"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYCHO_CUT] =
    {
        .name = COMPOUND_STRING("Corte Psiquico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ZEN_HEADBUTT] =
    {
        .name = COMPOUND_STRING("Cabecada Zen"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLASH_CANNON] =
    {
        .name = COMPOUND_STRING("Canhao de Luz"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRICK_ROOM] =
    {
        .name = COMPOUND_STRING("Sala Truque"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRACO_METEOR] =
    {
        .name = COMPOUND_STRING("Meteoro Draco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LEAF_STORM] =
    {
        .name = COMPOUND_STRING("Tempestade Folha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_WHIP] =
    {
        .name = COMPOUND_STRING("Chicote Poder"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_WRECKER] =
    {
        .name = COMPOUND_STRING("Quebra-Rocha"),
        .description = sHyperBeamDescription,
        .effect = EFFECT_HIT,
        .power = 150,
        .type = TYPE_ROCK,
    ...
    [MOVE_CROSS_POISON] =
    {
        .name = COMPOUND_STRING("Corte Veneno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_IRON_HEAD] =
    {
        .name = COMPOUND_STRING("Cabeca de Ferro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGNET_BOMB] =
    {
        .name = COMPOUND_STRING("Bomba Magnetica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STONE_EDGE] =
    {
        .name = COMPOUND_STRING("Gume de Pedra"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STEALTH_ROCK] =
    {
        .name = COMPOUND_STRING("Pedras Furtivas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GRASS_KNOT] =
    {
        .name = COMPOUND_STRING("No de Grama"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CHATTER] =
    {
        .name = COMPOUND_STRING("Tagarelar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_JUDGMENT] =
    {
        .name = COMPOUND_STRING("Julgamento"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BUG_BITE] =
    {
        .name = COMPOUND_STRING("Mordida Inseto"),
        .description = sPluckDescription,
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_BUG,
    ...
    [MOVE_CHARGE_BEAM] =
    {
        .name = COMPOUND_STRING("Raio de Carga"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WOOD_HAMMER] =
    {
        .name = COMPOUND_STRING("Martelo Madeira"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ATTACK_ORDER] =
    {
        .name = COMPOUND_STRING("Ordem Ataque"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DEFEND_ORDER] =
    {
        .name = COMPOUND_STRING("Ordem Defesa"),
        .description = COMPOUND_STRING(
            "Raises Defense and Sp. Def\n"
    ...
    [MOVE_HEAL_ORDER] =
    {
        .name = COMPOUND_STRING("Ordem Cura"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOUBLE_HIT] =
    {
        .name = COMPOUND_STRING("Golpe Duplo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROAR_OF_TIME] =
    {
        .name = COMPOUND_STRING("Rugido do Tempo"),
        .description = COMPOUND_STRING(
            "Powerful, but leaves the\n"
            "user immobile the next turn."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_SPACIAL_REND] =
    {
        .name = COMPOUND_STRING("Fenda Espacial"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LUNAR_DANCE] =
    {
        .name = COMPOUND_STRING("Danca Lunar"),
        .description = sHealingWishDescription,
    ...
    [MOVE_CRUSH_GRIP] =
    {
        .name = COMPOUND_STRING("Esmagamento"),
        .description = sWringOutDescription,
        .effect = EFFECT_POWER_BASED_ON_TARGET_HP,
        .power = 120,
        .type = TYPE_NORMAL,
    ...
    [MOVE_MAGMA_STORM] =
    {
        .name = COMPOUND_STRING("Tempestade Magma"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DARK_VOID] =
    {
        .name = COMPOUND_STRING("Vazio Sombrio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SEED_FLARE] =
    {
        .name = COMPOUND_STRING("Chama Semente"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_OMINOUS_WIND] =
    {
        .name = COMPOUND_STRING("Vento Sombrio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHADOW_FORCE] =
    {
        .name = COMPOUND_STRING("Sombra Final"),
    ...
    [MOVE_HONE_CLAWS] =
    {
        .name = COMPOUND_STRING("Afiar Garras"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WIDE_GUARD] =
    {
        .name = COMPOUND_STRING("Ampla Guarda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GUARD_SPLIT] =
    {
        .name = COMPOUND_STRING("Dividir Guarda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_SPLIT] =
    {
        .name = COMPOUND_STRING("Dividir Forca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WONDER_ROOM] =
    {
        .name = COMPOUND_STRING("Sala Maravilha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYSHOCK] =
    {
        .name = COMPOUND_STRING("Choque Psiquico"),
    ...
    [MOVE_VENOSHOCK] =
    {
        .name = COMPOUND_STRING("Choque Veneno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AUTOTOMIZE] =
    {
        .name = COMPOUND_STRING("Autotomizar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAGE_POWDER] =
    {
        .name = COMPOUND_STRING("Po de Raiva"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TELEKINESIS] =
    {
        .name = COMPOUND_STRING("Telecinesia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGIC_ROOM] =
    {
        .name = COMPOUND_STRING("Sala Magica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SMACK_DOWN] =
    {
        .name = COMPOUND_STRING("Derrubada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STORM_THROW] =
    {
        .name = COMPOUND_STRING("Tempestade"),
    ...
    [MOVE_FLAME_BURST] =
    {
        .name = COMPOUND_STRING("Explosao Chama"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SLUDGE_WAVE] =
    {
        .name = COMPOUND_STRING("Onda de Lama"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_QUIVER_DANCE] =
    {
        .name = COMPOUND_STRING("Danca Borboleta"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEAVY_SLAM] =
    {
        .name = COMPOUND_STRING("Peso Pesado"),
    ...
    [MOVE_SYNCHRONOISE] =
    {
        .name = COMPOUND_STRING("Sincronia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ELECTRO_BALL] =
    {
        .name = COMPOUND_STRING("Bola Eletrica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SOAK] =
    {
        .name = COMPOUND_STRING("Encharcar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLAME_CHARGE] =
    {
        .name = COMPOUND_STRING("Carga de Chamas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ACID_SPRAY] =
    {
        .name = COMPOUND_STRING("Spray Acido"),
        .description = COMPOUND_STRING(
            "Joga um acido corrosivo.\n"
            "Sharply reduces Sp. Def."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_FOUL_PLAY] =
    {
        .name = COMPOUND_STRING("Jogo Sujo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SIMPLE_BEAM] =
    {
        .name = COMPOUND_STRING("Raio Simples"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ENTRAINMENT] =
    {
        .name = COMPOUND_STRING("Entretenimento"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AFTER_YOU] =
    {
        .name = COMPOUND_STRING("Depois de Voce"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROUND] =
    {
        .name = COMPOUND_STRING("Canto em Roda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ECHOED_VOICE] =
    {
        .name = COMPOUND_STRING("Voz Ecoante"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STORED_POWER] =
    {
        .name = COMPOUND_STRING("Poder Armaz."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_QUICK_GUARD] =
    {
        .name = COMPOUND_STRING("Guarda Rapida"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ALLY_SWITCH] =
    {
        .name = COMPOUND_STRING("Troca Aliada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHELL_SMASH] =
    {
        .name = COMPOUND_STRING("Quebra-Casco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEAL_PULSE] =
    {
        .name = COMPOUND_STRING("Pulso de Cura"),
        .description = COMPOUND_STRING(
            "Recovers up to half the\n"
            "target's maximum HP."),
    ...
    [MOVE_SKY_DROP] =
    {
        .name = COMPOUND_STRING("Queda Livre"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHIFT_GEAR] =
    {
        .name = COMPOUND_STRING("Troca de Marcha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CIRCLE_THROW] =
    {
        .name = COMPOUND_STRING("Arremesso Circular"),
    ...
    [MOVE_INCINERATE] =
    {
        .name = COMPOUND_STRING("Incinerar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ACROBATICS] =
    {
        .name = COMPOUND_STRING("Acrobacia"),
        .description = COMPOUND_STRING(
            "Does double damage if the\n"
            "user has no item."),
    ...
    [MOVE_REFLECT_TYPE] =
    {
        .name = COMPOUND_STRING("Refletir Tipo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WATER_PLEDGE] =
    {
        .name = COMPOUND_STRING("Juramento de Agua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FIRE_PLEDGE] =
    {
        .name = COMPOUND_STRING("Juramento de Fogo"),
        .description = COMPOUND_STRING(
            "Attacks with a column of\n"
    ...
    [MOVE_GRASS_PLEDGE] =
    {
        .name = COMPOUND_STRING("Juramento de Grama"),
        .description = COMPOUND_STRING(
            "Attacks with a column of\n"
    ...
    [MOVE_VOLT_SWITCH] =
    {
        .name = COMPOUND_STRING("Troca de Volt"),
        .description = sUTurnDescription,
        .effect = EFFECT_HIT_ESCAPE,
        .power = 70,
        .type = TYPE_ELECTRIC,
    ...
    [MOVE_STRUGGLE_BUG] =
    {
        .name = COMPOUND_STRING("Luta Inseto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BULLDOZE] =
    {
        .name = COMPOUND_STRING("Atropelar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FROST_BREATH] =
    {
        .name = COMPOUND_STRING("Sopro de Gelo"),
        .description = sStormThrowDescription,
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 60 : 40,
        .type = TYPE_ICE,
    ...
    [MOVE_DRAGON_TAIL] =
    {
        .name = COMPOUND_STRING("Cauda do Dragao"),
        .description = sCircleThrowDescription,
        .effect = EFFECT_HIT_SWITCH_TARGET,
        .power = 60,
        .type = TYPE_DRAGON,
    ...
    [MOVE_ELECTROWEB] =
    {
        .name = COMPOUND_STRING("Teia Eletrica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WILD_CHARGE] =
    {
        .name = COMPOUND_STRING("Carga Selvagem"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEART_STAMP] =
    {
        .name = COMPOUND_STRING("Selo Coracao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HORN_LEECH] =
    {
        .name = COMPOUND_STRING("Dreno Chifre"),
        .description = sMegaDrainDescription,
        .effect = EFFECT_ABSORB,
        .power = 75,
        .type = TYPE_GRASS,
    ...
    [MOVE_SACRED_SWORD] =
    {
        .name = COMPOUND_STRING("Espada Sagrada"),
        .description = sChipAwayDescription,
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_RAZOR_SHELL] =
    {
        .name = COMPOUND_STRING("Concha de Corte"),
        .description = COMPOUND_STRING(
            "Tears at the foe with sharp\n"
    ...
    [MOVE_LEAF_TORNADO] =
    {
        .name = COMPOUND_STRING("Tornado Folha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STEAMROLLER] =
    {
        .name = COMPOUND_STRING("Rolo Compressor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COTTON_GUARD] =
    {
        .name = COMPOUND_STRING("Guarda Algodao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NIGHT_DAZE] =
    {
        .name = COMPOUND_STRING("Noite Sombria"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYSTRIKE] =
    {
        .name = COMPOUND_STRING("Golpe Psiquico"),
        .description = sPsyshockDescription,
        .effect = EFFECT_PSYSHOCK,
        .power = 100,
        .type = TYPE_PSYCHIC,
    ...
    [MOVE_TAIL_SLAP] =
    {
        .name = COMPOUND_STRING("Tapa de Cauda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEAD_CHARGE] =
    {
        .name = COMPOUND_STRING("Investida Cab."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GEAR_GRIND] =
    {
        .name = COMPOUND_STRING("Engrenagem"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SEARING_SHOT] =
    {
        .name = COMPOUND_STRING("Tiro Ardente"),
        .description = sLavaPlumeDescription,
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FIRE,
    ...
    [MOVE_TECHNO_BLAST] =
    {
        .name = COMPOUND_STRING("Tecno-Explosao"),
        .description = COMPOUND_STRING(
            "The type varies with the\n"
            "kind of Drive held."),
        .effect = EFFECT_CHANGE_TYPE_ON_ITEM,
    ...
    [MOVE_RELIC_SONG] =
    {
        .name = COMPOUND_STRING("Cancao Reliquia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SECRET_SWORD] =
    {
        .name = COMPOUND_STRING("Espada Secreta"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BOLT_STRIKE] =
    {
        .name = COMPOUND_STRING("Golpe de Volt"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLUE_FLARE] =
    {
        .name = COMPOUND_STRING("Chama Azul"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FIERY_DANCE] =
    {
        .name = COMPOUND_STRING("Danca de Fogo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FREEZE_SHOCK] =
    {
        .name = COMPOUND_STRING("Choque de Gelo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_BURN] =
    {
        .name = COMPOUND_STRING("Queimadura Gelo"),
        .description = COMPOUND_STRING(
            "A powerful 2-turn move that\n"
            "may inflict a burn."),
        .effect = EFFECT_TWO_TURNS_ATTACK,
    ...
    [MOVE_ICICLE_CRASH] =
    {
        .name = COMPOUND_STRING("Queda de Gelo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_V_CREATE] =
    {
        .name = COMPOUND_STRING("Criacao V"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FUSION_FLARE] =
    {
        .name = COMPOUND_STRING("Chama de Fusao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FUSION_BOLT] =
    {
        .name = COMPOUND_STRING("Raio de Fusao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLYING_PRESS] =
    {
        .name = COMPOUND_STRING("Prensa Aerea"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAT_BLOCK] =
    {
        .name = COMPOUND_STRING("Escudo Tatame"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STICKY_WEB] =
    {
        .name = COMPOUND_STRING("Teia Pegajosa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FELL_STINGER] =
    {
        .name = COMPOUND_STRING("Ferrada Mortal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PHANTOM_FORCE] =
    {
        .name = COMPOUND_STRING("Forca Fantasma"),
        .description = sShadowForceDescription,
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = 90,
        .type = TYPE_GHOST,
    ...
    [MOVE_TRICK_OR_TREAT] =
    {
        .name = COMPOUND_STRING("Travessura"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NOBLE_ROAR] =
    {
        .name = COMPOUND_STRING("Rugido Nobre"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ION_DELUGE] =
    {
        .name = COMPOUND_STRING("Diluvio de Ions"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Carga Parab."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FORESTS_CURSE] =
    {
        .name = COMPOUND_STRING("Maldicao Floresta"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PETAL_BLIZZARD] =
    {
        .name = COMPOUND_STRING("Tempestade Petala"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Voz Cativante"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PARTING_SHOT] =
    {
        .name = COMPOUND_STRING("Despedida"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAINING_KISS] =
    {
        .name = COMPOUND_STRING("Beijo Dreno"),
    ...
    [MOVE_CRAFTY_SHIELD] =
    {
        .name = COMPOUND_STRING("Escudo Astuto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLOWER_SHIELD] =
    {
        .name = COMPOUND_STRING("Escudo de Flores"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GRASSY_TERRAIN] =
    {
        .name = COMPOUND_STRING("Campo de Grama"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MISTY_TERRAIN] =
    {
        .name = COMPOUND_STRING("Campo de Nevoa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ELECTRIFY] =
    {
        .name = COMPOUND_STRING("Eletrificar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PLAY_ROUGH] =
    {
        .name = COMPOUND_STRING("Brincar Pesado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FAIRY_WIND] =
    {
        .name = COMPOUND_STRING("Vento de Fada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MOONBLAST] =
    {
        .name = COMPOUND_STRING("Explosao Lunar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FAIRY_LOCK] =
    {
        .name = COMPOUND_STRING("Prisao de Fada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_KINGS_SHIELD] =
    {
        .name = COMPOUND_STRING("Escudo do Rei"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DIAMOND_STORM] =
    {
        .name = COMPOUND_STRING("Tempestade Diam."),
        .description = COMPOUND_STRING(
            "Whips up a storm of\n"
    ...
    [MOVE_STEAM_ERUPTION] =
    {
        .name = COMPOUND_STRING("Erupcao Vapor"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Hiperespaco"),
    ...
    [MOVE_WATER_SHURIKEN] =
    {
        .name = COMPOUND_STRING("Estrela Ninja"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MYSTICAL_FIRE] =
    {
        .name = COMPOUND_STRING("Fogo Mistico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIKY_SHIELD] =
    {
        .name = COMPOUND_STRING("Escudo Espinhos"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AROMATIC_MIST] =
    {
        .name = COMPOUND_STRING("Nevoa Aromatica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EERIE_IMPULSE] =
    {
        .name = COMPOUND_STRING("Impulso Estranho"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VENOM_DRENCH] =
    {
        .name = COMPOUND_STRING("Dreno Veneno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GEOMANCY] =
    {
        .name = COMPOUND_STRING("Geomancia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGNETIC_FLUX] =
    {
        .name = COMPOUND_STRING("Fluxo Magnetico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HAPPY_HOUR] =
    {
        .name = COMPOUND_STRING("Hora Feliz"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HOLD_HANDS] =
    {
        .name = COMPOUND_STRING("Dar as Maos"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BABY_DOLL_EYES] =
    {
        .name = COMPOUND_STRING("Olhos de Boneca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_INFESTATION] =
    {
        .name = COMPOUND_STRING("Infestacao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_UP_PUNCH] =
    {
        .name = COMPOUND_STRING("Soco de Poder"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_OBLIVION_WING] =
    {
        .name = COMPOUND_STRING("Asa do Abismo"),
        .description = sDrainingKissDescription,
        .effect = EFFECT_ABSORB,
        .power = 80,
        .type = TYPE_FLYING,
    ...
    [MOVE_THOUSAND_WAVES] =
    {
        .name = COMPOUND_STRING("Mil Ondas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LANDS_WRATH] =
    {
        .name = COMPOUND_STRING("Ira da Terra"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ORIGIN_PULSE] =
    {
        .name = COMPOUND_STRING("Pulso Origem"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Laminas Abismo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_ASCENT] =
    {
        .name = COMPOUND_STRING("Ascensao Dragao"),
        .description = sCloseCombatDescription,
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_FLYING,
    ...
    {
        .name = COMPOUND_STRING("Furia Espacial"),
        .description = sHyperspaceHoleDescription,
    ...
    {
        .name = COMPOUND_STRING("Impressao"),
        .description = COMPOUND_STRING(
            "Hits hard and first.\n"
    ...
    [MOVE_BANEFUL_BUNKER] =
    {
        .name = COMPOUND_STRING("Bunkers Toxico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIRIT_SHACKLE] =
    {
        .name = COMPOUND_STRING("Flecha Sombria"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DARKEST_LARIAT] =
    {
        .name = COMPOUND_STRING("Lariat Sombrio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPARKLING_ARIA] =
    {
        .name = COMPOUND_STRING("Aria Cintilante"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_HAMMER] =
    {
        .name = COMPOUND_STRING("Martelo de Gelo"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Forca Bruta"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STRENGTH_SAP] =
    {
        .name = COMPOUND_STRING("Suga Forca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SOLAR_BLADE] =
    {
        .name = COMPOUND_STRING("Lamina Solar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TOXIC_THREAD] =
    {
        .name = COMPOUND_STRING("Fio Toxico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LASER_FOCUS] =
    {
        .name = COMPOUND_STRING("Foco Laser"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THROAT_CHOP] =
    {
        .name = COMPOUND_STRING("Golpe Garganta"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Campo Psiquico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FIRE_LASH] =
    {
        .name = COMPOUND_STRING("Chicote de Fogo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_TRIP] =
    {
        .name = COMPOUND_STRING("Poder Total"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPEED_SWAP] =
    {
        .name = COMPOUND_STRING("Troca de Vel."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SMART_STRIKE] =
    {
        .name = COMPOUND_STRING("Golpe Inteligente"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PURIFY] =
    {
        .name = COMPOUND_STRING("Purificar"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Danca Revelacao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CORE_ENFORCER] =
    {
        .name = COMPOUND_STRING("Executor Central"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TROP_KICK] =
    {
        .name = COMPOUND_STRING("Chute Tropical"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BEAK_BLAST] =
    {
        .name = COMPOUND_STRING("Explosao de Bico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_HAMMER] =
    {
        .name = COMPOUND_STRING("Martelo Dragao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BRUTAL_SWING] =
    {
        .name = COMPOUND_STRING("Balanco Brutal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AURORA_VEIL] =
    {
        .name = COMPOUND_STRING("Veu de Aurora"),
        #if B_PREFERRED_ICE_WEATHER == B_ICE_WEATHER_SNOW
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHELL_TRAP] =
    {
        .name = COMPOUND_STRING("Armadilha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLEUR_CANNON] =
    {
        .name = COMPOUND_STRING("Canhao de Flor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYCHIC_FANGS] =
    {
        .name = COMPOUND_STRING("Presas Psiquicas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHADOW_BONE] =
    {
        .name = COMPOUND_STRING("Osso Sombrio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LIQUIDATION] =
    {
        .name = COMPOUND_STRING("Liquidacao"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Laser Prismatico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPECTRAL_THIEF] =
    {
        .name = COMPOUND_STRING("Roubo Espectral"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Golpe de Sol"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MOONGEIST_BEAM] =
    {
        .name = COMPOUND_STRING("Raio da Lua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TEARFUL_LOOK] =
    {
        .name = COMPOUND_STRING("Olhar Triste"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ZING_ZAP] =
    {
        .name = COMPOUND_STRING("Choque Zap"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Ira da Natureza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MULTI_ATTACK] =
    {
        .name = COMPOUND_STRING("Multi-Ataque"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIND_BLOWN] =
    {
        .name = COMPOUND_STRING("Cabeca Quente"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PLASMA_FISTS] =
    {
        .name = COMPOUND_STRING("Socos Plasma"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PHOTON_GEYSER] =
    {
        .name = COMPOUND_STRING("Foton Geiser"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Ferro Duplo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DYNAMAX_CANNON] =
    {
        .name = COMPOUND_STRING("Canhao Dyna"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SNIPE_SHOT] =
    {
        .name = COMPOUND_STRING("Tiro de Precisao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STUFF_CHEEKS] =
    {
        .name = COMPOUND_STRING("Bochechas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NO_RETREAT] =
    {
        .name = COMPOUND_STRING("Sem Retirada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGIC_POWDER] =
    {
        .name = COMPOUND_STRING("Po Magico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TEATIME] =
    {
        .name = COMPOUND_STRING("Hora do Cha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BOLT_BEAK] =
    {
        .name = COMPOUND_STRING("Bico de Volt"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COURT_CHANGE] =
    {
        .name = COMPOUND_STRING("Troca de Campo"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Alma Sonora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BODY_PRESS] =
    {
        .name = COMPOUND_STRING("Prensa Corporal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PYRO_BALL] =
    {
        .name = COMPOUND_STRING("Bola de Fogo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BEHEMOTH_BLADE] =
    {
        .name = COMPOUND_STRING("Lamina Gigante"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BEHEMOTH_BASH] =
    {
        .name = COMPOUND_STRING("Escudo Gigante"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AURA_WHEEL] =
    {
        .name = COMPOUND_STRING("Roda de Aura"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BREAKING_SWIPE] =
    {
        .name = COMPOUND_STRING("Quebra-Garras"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_APPLE_ACID] =
    {
        .name = COMPOUND_STRING("Acido de Maca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GRAV_APPLE] =
    {
        .name = COMPOUND_STRING("Queda de Maca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIRIT_BREAK] =
    {
        .name = COMPOUND_STRING("Quebra-Espirito"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_JET_PUNCH] =
    {
        .name = COMPOUND_STRING("Soco Jato"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPICY_EXTRACT] =
    {
        .name = COMPOUND_STRING("Extrato Picante"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Bomba Populac."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_SPINNER] =
    {
        .name = COMPOUND_STRING("Giro de Gelo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GLAIVE_RUSH] =
    {
        .name = COMPOUND_STRING("Avanco de Glave"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Bencao Vital"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SALT_CURE] =
    {
        .name = COMPOUND_STRING("Cura de Sal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRIPLE_DIVE] =
    {
        .name = COMPOUND_STRING("Mergulho Triplo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MORTAL_SPIN] =
    {
        .name = COMPOUND_STRING("Giro Mortal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_KOWTOW_CLEAVE] =
    {
        .name = COMPOUND_STRING("Corte Curvado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLOWER_TRICK] =
    {
        .name = COMPOUND_STRING("Truque Floral"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TORCH_SONG] =
    {
        .name = COMPOUND_STRING("Samba de Fogo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AQUA_STEP] =
    {
        .name = COMPOUND_STRING("Passo de Agua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAGING_BULL] =
    {
        .name = COMPOUND_STRING("Touro Furioso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAKE_IT_RAIN] =
    {
        .name = COMPOUND_STRING("Chuva Dinheiro"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Colisao Fria"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ELECTRO_DRIFT] =
    {
        .name = COMPOUND_STRING("Deriva Eletrica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHED_TAIL] =
    {
        .name = COMPOUND_STRING("Troca-Cauda"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Recepcao Fria"),
    ...
    [MOVE_TIDY_UP] =
    {
        .name = COMPOUND_STRING("Arrumacao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRAILBLAZE] =
    {
        .name = COMPOUND_STRING("Abrir Caminho"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CHILLING_WATER] =
    {
        .name = COMPOUND_STRING("Agua Gelada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYPER_DRILL] =
    {
        .name = COMPOUND_STRING("Hiper Broca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TWIN_BEAM] =
    {
        .name = COMPOUND_STRING("Raio Gemeo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAGE_FIST] =
    {
        .name = COMPOUND_STRING("Punho Furioso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ARMOR_CANNON] =
    {
        .name = COMPOUND_STRING("Canhao Armad."),
        .description = COMPOUND_STRING(
            "A strong attack but lowers\n"
            "the defensive stats."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_BITTER_BLADE] =
    {
        .name = COMPOUND_STRING("Espada Amarga"),
        .description = COMPOUND_STRING(
            "An attack that absorbs\n"
            "half the damage inflicted."),
        .effect = EFFECT_ABSORB,
    ...
    [MOVE_DOUBLE_SHOCK] =
    {
        .name = COMPOUND_STRING("Choque Duplo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GIGATON_HAMMER] =
    {
        .name = COMPOUND_STRING("Martelo Gigante"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COMEUPPANCE] =
    {
        .name = COMPOUND_STRING("Retribuicao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AQUA_CUTTER] =
    {
        .name = COMPOUND_STRING("Corte de Agua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLAZING_TORQUE] =
    {
        .name = COMPOUND_STRING("Torque Ardente"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FIRE,
    ...
    [MOVE_WICKED_TORQUE] =
    {
        .name = COMPOUND_STRING("Torque Maligno"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_DARK,
    ...
    [MOVE_NOXIOUS_TORQUE] =
    {
        .name = COMPOUND_STRING("Torque Toxico"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_POISON,
    ...
    [MOVE_COMBAT_TORQUE] =
    {
        .name = COMPOUND_STRING("Torque Combate"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_MAGICAL_TORQUE] =
    {
        .name = COMPOUND_STRING("Torque Magico"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FAIRY,
    ...
    [MOVE_PSYBLADE] =
    {
        .name = COMPOUND_STRING("Lamina Psiquica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYDRO_STEAM] =
    {
        .name = COMPOUND_STRING("Vapor de Agua"),
        .description = COMPOUND_STRING(
            "This move's power increases\n"
    ...
    [MOVE_BLOOD_MOON] =
    {
        .name = COMPOUND_STRING("Lua de Sangue"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MATCHA_GOTCHA] =
    {
        .name = COMPOUND_STRING("Gole de Matcha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SYRUP_BOMB] =
    {
        .name = COMPOUND_STRING("Bomba de Xarope"),
        .description = COMPOUND_STRING(
            "Lowers the foe's speed\n"
    ...
    [MOVE_IVY_CUDGEL] =
    {
        .name = COMPOUND_STRING("Porrete de Hera"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ELECTRO_SHOT] =
    {
        .name = COMPOUND_STRING("Tiro Eletrico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TERA_STARSTORM] =
    {
        .name = COMPOUND_STRING("Chuva Estelar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FICKLE_BEAM] =
    {
        .name = COMPOUND_STRING("Raio Inconst."),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Baluarte Ard."),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIGHTY_CLEAVE] =
    {
        .name = COMPOUND_STRING("Corte Poderoso"),
        .description = sFeintDescription,
        .effect = EFFECT_HIT,
        .power = 95,
        .type = TYPE_ROCK,
    ...
    [MOVE_TACHYON_CUTTER] =
    {
        .name = COMPOUND_STRING("Corte Taquion"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HARD_PRESS] =
    {
        .name = COMPOUND_STRING("Prensagem"),
        .description = sWringOutDescription,
        .effect = EFFECT_POWER_BASED_ON_TARGET_HP,
        .power = 100,
        .type = TYPE_STEEL,
    ...
    [MOVE_DRAGON_CHEER] =
    {
        .name = COMPOUND_STRING("Vibracao Dragao"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ALLURING_VOICE] =
    {
        .name = COMPOUND_STRING("Voz Sedutora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SUPERCELL_SLAM] =
    {
        .name = COMPOUND_STRING("Pancada Celula"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYCHIC_NOISE] =
    {
        .name = COMPOUND_STRING("Ruido Psiquico"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Corrente Malig."),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Carreira Mortal"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Surra Total"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Ataque Aereo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ACID_DOWNPOUR] =
    {
        .name = COMPOUND_STRING("Diluvio Acido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TECTONIC_RAGE] =
    {
        .name = COMPOUND_STRING("Furia Tectonica"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Giro Selvagem"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Pesadelo Final"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Impacto Broca"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Super-Inferno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYDRO_VORTEX] =
    {
        .name = COMPOUND_STRING("Vortex de Agua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLOOM_DOOM] =
    {
        .name = COMPOUND_STRING("Desabrochar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GIGAVOLT_HAVOC] =
    {
        .name = COMPOUND_STRING("Caos de Volt"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Quebra Psiquica"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Impacto Zero"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Draco Devastad."),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Eclipe Sombrio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TWINKLE_TACKLE] =
    {
        .name = COMPOUND_STRING("Impacto Fada"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("10 Milhoes Volt"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Surf Eletrico"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Evo-Impulso"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Chuva de Flechas"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Salto Maligno"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Aria Oceanica"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Corte de Rocha"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Abraco Eterno"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Guarda de Alola"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Impacto Solar"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Impacto Lunar"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Luz do Abismo"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Golpe 7 Estrelas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_GUARD] =
    {
        .name = COMPOUND_STRING("Guarda Max"),
        .description = sProtectDescription,
        .effect = EFFECT_PROTECT,
        .power = 0,
        .type = TYPE_NORMAL,
    ...
    [MOVE_MAX_FLARE] =
    {
        .name = COMPOUND_STRING("Chama Max"),
        .description = COMPOUND_STRING(
            "Fire Dynamax attack.\n"
    ...
    [MOVE_MAX_FLUTTERBY] =
    {
        .name = COMPOUND_STRING("Inseto Max"),
        .description = COMPOUND_STRING(
            "Bug Dynamax attack.\n"
    ...
    [MOVE_MAX_LIGHTNING] =
    {
        .name = COMPOUND_STRING("Relampago Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_STRIKE] =
    {
        .name = COMPOUND_STRING("Ataque Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_PHANTASM] =
    {
        .name = COMPOUND_STRING("Fantasma Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_HAILSTORM] =
    {
        .name = COMPOUND_STRING("Granizo Max"),
        .description = COMPOUND_STRING(
            "Ice Dynamax attack.\n"
    ...
    [MOVE_MAX_OOZE] =
    {
        .name = COMPOUND_STRING("Veneno Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_AIRSTREAM] =
    {
        .name = COMPOUND_STRING("Vento Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_STARFALL] =
    {
        .name = COMPOUND_STRING("Estrela Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_WYRMWIND] =
    {
        .name = COMPOUND_STRING("Dragao Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_MINDSTORM] =
    {
        .name = COMPOUND_STRING("Psiquico Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_ROCKFALL] =
    {
        .name = COMPOUND_STRING("Rocha Max"),
        .description = COMPOUND_STRING(
            "Rock Dynamax attack.\n"
            "Summons a sandstorm."),
        .effect = EFFECT_MAX_MOVE,
    ...
    [MOVE_MAX_QUAKE] =
    {
        .name = COMPOUND_STRING("Terra Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_DARKNESS] =
    {
        .name = COMPOUND_STRING("Trevas Max"),
        .description = COMPOUND_STRING(
            "Dark Dynamax attack.\n"
    ...
    [MOVE_MAX_OVERGROWTH] =
    {
        .name = COMPOUND_STRING("Planta Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Chicote G-Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_WILDFIRE] =
    {
        .name = COMPOUND_STRING("Fogo G-Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Canhao G-Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_BEFUDDLE] =
    {
        .name = COMPOUND_STRING("Confusao G-Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Choque G-Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Ouro G-Max"),
        .description = COMPOUND_STRING(
            "G-max Meowth attack.\n"
    ...
    {
        .name = COMPOUND_STRING("Golpe G-Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_TERROR] =
    {
        .name = COMPOUND_STRING("Terror G-Max"),
        .description = COMPOUND_STRING(
            "G-max Gengar attack.\n"
    ...
    {
        .name = COMPOUND_STRING("Espuma G-Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Ressoar G-Max"),
        .description = COMPOUND_STRING(
            "G-max Lapras attack.\n"
    ...
    [MOVE_G_MAX_CUDDLE] =
    {
        .name = COMPOUND_STRING("Abraco G-Max"),
        .description = COMPOUND_STRING(
            "G-max Eevee attack.\n"
    ...
    {
        .name = COMPOUND_STRING("Recarga G-Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_MALODOR] =
    {
        .name = COMPOUND_STRING("Fedor G-Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_MELTDOWN] =
    {
        .name = COMPOUND_STRING("Fusao G-Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Tambor G-Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_FIREBALL] =
    {
        .name = COMPOUND_STRING("Bola G-Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Tiro G-Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Vento G-Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_GRAVITAS] =
    {
        .name = COMPOUND_STRING("Gravit. G-Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Pedra G-Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Lava G-Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_TARTNESS] =
    {
        .name = COMPOUND_STRING("Azedo G-Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Doce G-Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Areia G-Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_SMITE] =
    {
        .name = COMPOUND_STRING("Punicao G-Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_SNOOZE] =
    {
        .name = COMPOUND_STRING("Sono G-Max"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_FINALE] =
    {
        .name = COMPOUND_STRING("Final G-Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Aco G-Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Dreno G-Max"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Fluxo G-Max"),
        .description = sGMaxOneBlowDescription,    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_WATER,
