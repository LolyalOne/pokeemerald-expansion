...
static const u8 sText_ChooseAPkmn[] = _("Escolha um POKeMON.");
static const u8 sText_Summary[] = _("SUMARIO");
static const u8 sText_Trade[] = _("TROCA");
static const u8 sText_CancelTrade[] = _("Cancelar troca?");
static const u8 sJPText_PressBButtonToQuit[] = _("Bボタン　で　もどります");
static const u8 sText_Summary2[] = _("SUMARIO");
static const u8 sText_Trade2[] = _("TROCA");
...
static const u8 sText_YourFriendWantsToTrade[] = _("Seu amigo quer\ntrocar POKeMON.");
