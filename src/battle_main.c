...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_HIKER] = { _("TRAILISTA"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    ...
    [TRAINER_CLASS_COOLTRAINER] = { _("TREIN. ELITE"), 12, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] = { _("TR. PASSARO"), 8 },
    [TRAINER_CLASS_COLLECTOR] = { _("COLECIONADOR"), 15, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("SWIMMER♂"), 2, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] = { _("TEAM MAGMA") },
    [TRAINER_CLASS_EXPERT] = { _("ESPECIALISTA"), 10 },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("ADM. AQUA"), 10 },
    [TRAINER_CLASS_BLACK_BELT] = { _("FAIXA PRETA"), 8, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("LIDER AQUA"), 20, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] = { _("BRUXA"), 6 },
    [TRAINER_CLASS_AROMA_LADY] = { _("MOÇA AROMA"), 10 },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("RUINOMANIACO"), 15 },
    [TRAINER_CLASS_INTERVIEWER] = { _("REPORTER"), 12 },
    [TRAINER_CLASS_TUBER_F] = { _("BANHISTA"), 1 },
    [TRAINER_CLASS_TUBER_M] = { _("BANHISTA"), 1 },
    [TRAINER_CLASS_LADY] = { _("MADAME"), 50 },
    [TRAINER_CLASS_BEAUTY] = { _("BELEZA"), 20, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_GREAT : BALL_POKE },
    [TRAINER_CLASS_RICH_BOY] = { _("RICO"), 50 },
    [TRAINER_CLASS_POKEMANIAC] = { _("POKéMANIAC"), 15 },
    [TRAINER_CLASS_GUITARIST] = { _("GUITARRISTA"), 8 },
    [TRAINER_CLASS_KINDLER] = { _("PIROMANIACO"), 8 },
    [TRAINER_CLASS_CAMPER] = { _("CAMPISTA"), 4 },
    [TRAINER_CLASS_PICNICKER] = { _("PIQUENIQUE"), 4 },
    [TRAINER_CLASS_BUG_MANIAC] = { _("ENTOMOLOGO"), 15 },
    [TRAINER_CLASS_PSYCHIC] = { _("PSIQUICO"), 6 },
    [TRAINER_CLASS_GENTLEMAN] = { _("GENTLEMAN"), 20, BALL_LUXURY },
    [TRAINER_CLASS_ELITE_FOUR] = { _("ELITE FOUR"), 25, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] = { _("LIDER"), 25, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    ...
    [TRAINER_CLASS_YOUNGSTER] = { _("JOVEM"), 4 },
    [TRAINER_CLASS_CHAMPION] = { _("CAMPEAO"), 50, BALL_ULTRA },
    ...
    [TRAINER_CLASS_DRAGON_TAMER] = { _("DOMADRAGAO"), 12 },
    [TRAINER_CLASS_NINJA_BOY] = { _("NINJA"), 3 },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("LUTADORA"), 6 },
    [TRAINER_CLASS_PARASOL_LADY] = { _("DAMA PARASOL"), 10 },
    [TRAINER_CLASS_SWIMMER_F] = { _("SWIMMER♀"), 2, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("GEMEAS"), 3 },
    [TRAINER_CLASS_SAILOR] = { _("MARINHEIRO"), 8 },
    [TRAINER_CLASS_COOLTRAINER_2] = { _("TREIN. ELITE"), 5, BALL_ULTRA },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("ADM. MAGMA"), 10 },
    [TRAINER_CLASS_RIVAL] = { _("{PKMN} TRAINER"), 15 },
    [TRAINER_CLASS_BUG_CATCHER] = { _("PEGADOR INST"), 4 },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} RANGER"), 12 },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("LIDER MAGMA"), 20, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("MOÇA"), 4 },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("JOVEM CASAL"), 8 },
    [TRAINER_CLASS_OLD_COUPLE] = { _("VELHO CASAL"), 10 },
    [TRAINER_CLASS_SIS_AND_BRO] = { _("IRMAOS"), 3 },
    [TRAINER_CLASS_SALON_MAIDEN] = { _("DAMA SALAO"), 5, BALL_ULTRA },
    [TRAINER_CLASS_DOME_ACE] = { _("AS DO DOMO") },
    [TRAINER_CLASS_PALACE_MAVEN] = { _("MESTRE PALAC") },
    [TRAINER_CLASS_ARENA_TYCOON] = { _("MAGNATA AREN") },
    [TRAINER_CLASS_FACTORY_HEAD] = { _("CHEFE FABR.") },
    [TRAINER_CLASS_PIKE_QUEEN] = { _("RAINHA SERP.") },
    [TRAINER_CLASS_PYRAMID_KING] = { _("REI PIRAMIDE") },
    [TRAINER_CLASS_RS_PROTAG] = { _("{PKMN} TRAINER") },

    [TRAINER_CLASS_YOUNGSTER_FRLG] =       { _("JOVEM"), 4 },
    [TRAINER_CLASS_BUG_CATCHER_FRLG] =     { _("PEGADOR INST"), 3 },
    [TRAINER_CLASS_LASS_FRLG] =            { _("MOÇA"), 4 },
    [TRAINER_CLASS_SAILOR_FRLG] =          { _("MARINHEIRO"), 8 },
    [TRAINER_CLASS_CAMPER_FRLG] =          { _("CAMPISTA"), 5 },
    [TRAINER_CLASS_PICNICKER_FRLG] =       { _("PIQUENIQUE"), 5 },
    [TRAINER_CLASS_POKEMANIAC_FRLG] =      { _("POKéMANIAC"), 12 },
    [TRAINER_CLASS_SUPER_NERD_FRLG] =      { _("SUPER NERD"), 6 },
    [TRAINER_CLASS_HIKER_FRLG] =           { _("TRAILISTA"), 9 },
    [TRAINER_CLASS_BIKER_FRLG] =           { _("MOTOQUEIRO"), 5 },
    [TRAINER_CLASS_BURGLAR_FRLG] =         { _("LADRAO"), 22 },
    [TRAINER_CLASS_ENGINEER_FRLG] =        { _("ENGENHEIRO"), 12 },
    [TRAINER_CLASS_FISHERMAN_FRLG] =       { _("PESCADOR"), 9, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_SWIMMER_M_FRLG] =       { _("SWIMMER♂"), 1 },
    [TRAINER_CLASS_CUE_BALL_FRLG] =        { _("CARECA"), 6 },
    [TRAINER_CLASS_GAMER_FRLG] =           { _("JOGADOR"), 18 },
    [TRAINER_CLASS_BEAUTY_FRLG] =          { _("BELEZA"), 18 },
    [TRAINER_CLASS_SWIMMER_F_FRLG] =       { _("SWIMMER♀"), 1, BALL_DIVE },
    [TRAINER_CLASS_PSYCHIC_FRLG] =         { _("PSIQUICO"), 5 },
    [TRAINER_CLASS_ROCKER_FRLG] =          { _("ROCKER"), 6 },
    [TRAINER_CLASS_JUGGLER_FRLG] =         { _("MALABARISTA"), 10 },
    [TRAINER_CLASS_TAMER_FRLG] =           { _("DOMADOR"), 10 },
    [TRAINER_CLASS_BIRD_KEEPER_FRLG] =     { _("TR. PASSARO"), 6 },
    [TRAINER_CLASS_BLACK_BELT_FRLG] =      { _("FAIXA PRETA"), 6, BALL_ULTRA },
    [TRAINER_CLASS_RIVAL_EARLY_FRLG] =     { _("RIVAL"), 4 },
    [TRAINER_CLASS_SCIENTIST_FRLG] =       { _("CIENTISTA"), 12 },
    [TRAINER_CLASS_BOSS_FRLG] =            { _("CHEFE"), 25 },
    [TRAINER_CLASS_LEADER_FRLG] =          { _("LIDER"), 25 },
    [TRAINER_CLASS_TEAM_ROCKET_FRLG] =     { _("TEAM ROCKET"), 8 },
    [TRAINER_CLASS_COOLTRAINER_FRLG] =     { _("TREIN. ELITE"), 9, BALL_ULTRA },
    ...
    [TRAINER_CLASS_CHAMPION_FRLG] =        { _("CAMPEAO"), 25 },
    [TRAINER_CLASS_CHANNELER_FRLG] =       { _("MEDIUM"), 8 },
    [TRAINER_CLASS_TWINS_FRLG] =           { _("GEMEAS"), 3 },
    [TRAINER_CLASS_COOL_COUPLE_FRLG] =     { _("CASAL ELITE"), 6 },
    [TRAINER_CLASS_YOUNG_COUPLE_FRLG] =    { _("JOVEM CASAL"), 7 },
    [TRAINER_CLASS_CRUSH_KIN_FRLG] =       { _("PARENTES"), 6 },
    [TRAINER_CLASS_SIS_AND_BRO_FRLG] =     { _("IRMAOS"), 1 },
    [TRAINER_CLASS_PKMN_PROF_FRLG] =       { _("{PKMN} PROF."), 25 },
    [TRAINER_CLASS_PLAYER_FRLG] =          { _("{PKMN} TRAINER"), 1 },
    [TRAINER_CLASS_CRUSH_GIRL_FRLG] =      { _("LUTADORA"), 6 },
    [TRAINER_CLASS_TUBER_FRLG] =           { _("BANHISTA"), 1 },
    ...
    [TRAINER_CLASS_AROMA_LADY_FRLG] =      { _("MOÇA AROMA"), 7 },
    [TRAINER_CLASS_RUIN_MANIAC_FRLG] =     { _("RUINOMANIACO"), 12 },
    [TRAINER_CLASS_LADY_FRLG] =            { _("MADAME"), 50 },
    [TRAINER_CLASS_PAINTER_FRLG] =         { _("PINTOR"), 4 },
};
                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (i = 0; i < monsCount; i++)
        {
            ...
            }
            {
                ...
                u32 playerMaxLevel = GetPlayerPartyHighestLevel();
                level = playerMaxLevel + 10;
            ...
            // Custom Rule: 2x HP, DEF, SPDEF, SPEED. ATK and SPATK remain 1x.
            {
                u32 hp = GetMonData(&party[i], MON_DATA_MAX_HP) * 2;
                u32 current_hp = GetMonData(&party[i], MON_DATA_HP) * 2;
                u32 def = GetMonData(&party[i], MON_DATA_DEF) * 2;
                u32 spdef = GetMonData(&party[i], MON_DATA_SPDEF) * 2;
                u32 speed = GetMonData(&party[i], MON_DATA_SPEED) * 2;

                if (hp > 9999) hp = 9999;
                if (current_hp > 9999) current_hp = 9999;
                if (def > 999) def = 999;
                if (spdef > 999) spdef = 999;
                if (speed > 999) speed = 999;

                SetMonData(&party[i], MON_DATA_MAX_HP, &hp);
                SetMonData(&party[i], MON_DATA_HP, &current_hp);
                SetMonData(&party[i], MON_DATA_DEF, &def);
                SetMonData(&party[i], MON_DATA_SPDEF, &spdef);
                SetMonData(&party[i], MON_DATA_SPEED, &speed);
            }
