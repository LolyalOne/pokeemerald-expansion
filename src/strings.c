...
const u8 gText_ThisIsAPokemon[] = _("Isto e o que chamamos de “POKeMON”.{PAUSE 96}\p");
...
const u8 gText_PokedexRegistration[] = _("Registro na POKeDEX completo.");
const u8 gText_HTHeight[] = _("HT");
const u8 gText_WTWeight[] = _("WT");
const u8 gText_SearchingPleaseWait[] = _("Buscando...\nPor favor, espere.");
const u8 gText_SearchCompleted[] = _("Busca completa.");
const u8 gText_NoMatchingPkmnWereFound[] = _("Nenhum POKeMON encontrado.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Busque POKeMON baseados em\nparametros selecionados.");
...
const u8 gText_ListByFirstLetter[] = _("Lista por ordem alfabetica.\nApenas POKeMON vistos.");
const u8 gText_ListByBodyColor[] = _("Lista por cor do corpo.\nApenas POKeMON vistos.");
const u8 gText_ListByType[] = _("Lista por tipo.\nApenas POKeMON capturados.");
...
const u8 gText_DexSortNumericalDescription[] = _("Os POKeMON sao listados pelo\nseu numero.");
const u8 gText_DexSortAtoZDescription[] = _("POKeMON vistos e pegos sao\nlistados em ordem alfabetica.");
const u8 gText_DexSortHeaviestDescription[] = _("Lista do mais pesado para o\nmais leve.");
const u8 gText_DexSortLightestDescription[] = _("Lista do mais leve para o\nmais pesado.");
const u8 gText_DexSortTallestDescription[] = _("Lista do maior para o\nmenor.");
const u8 gText_DexSortSmallestDescription[] = _("Lista do menor para o\nmaior.");
...
const u8 gText_HOFDexRating[] = _("Spotted POKeMON: {STR_VAR_1}!\nOwned POKeMON: {STR_VAR_2}!\pPROF. BIRCH's POKéDEX rating!\pPROF. BIRCH: Let's see…\p");
...
const u8 gText_LeagueChamp[] = _("CAMPEAO DA LIGA!\nPARABENS, LUCAS!");
...
const u8 gText_BirchInTrouble[] = _("O PROF. BIRCH esta em perigo!\nEscolha um POKeMON e ajude-o!");
const u8 gText_ConfirmStarterChoice[] = _("Voce escolhe este POKeMON?");
const u8 gText_Pokemon4[] = _("POKeMON"); // Unused
const u8 gText_FlyToWhere[] = _("VOAR para onde?");
const u8 gMenuText_Use[] = _("USE");
const u8 gMenuText_Toss[] = _("JOGAR FORA");
...
const u8 gText_GoBackPrevMenu[] = _("Voltar para o\nmenu anterior.");
const u8 gText_WhatWouldYouLike[] = _("O que voce deseja fazer?");
...
const u8 gText_TheField[] = _("o campo");
const u8 gText_TheBattle[] = _("a batalha");
const u8 gText_ThePokemonList[] = _("a lista POKeMON");
const u8 gText_TheShop[] = _("a loja");
const u8 gText_ThePC[] = _("o PC");
...
const u8 gText_ReturnToVar1[] = _("Voltar para\n{STR_VAR_1}.");

const u8 *const gPocketNamesStringsTable[] =
{
    [POCKET_ITEMS] =        COMPOUND_STRING("ITENS"),
    [POCKET_POKE_BALLS] =   COMPOUND_STRING("POKeBOLAS"),
    [POCKET_TM_HM]  =       COMPOUND_STRING("TMs e HMs"),
    [POCKET_BERRIES] =      COMPOUND_STRING("BAGAS"),
    [POCKET_KEY_ITEMS] =    COMPOUND_STRING("ITENS CHAVE")
};
...
const u8 gText_SoldOut[] = _("ESGOTADO");
const u8 gText_InBagVar1[] = _("NA MOCHILA: {STR_VAR_1}");
...
const u8 gText_HereYouGoThankYou[] = _("Aqui esta!\nMuito obrigado.");
...
const u8 gText_NoMoreThanVar1Pkmn[] = _("Apenas {STR_VAR_1} POKeMON\npodem entrar.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MailTakenFromPkmn[] = _("A CARTA foi retirada do\nPOKeMON.{PAUSE_UNTIL_PRESS}");
const u8 gText_SwitchedPkmnItem[] = _("The {STR_VAR_2} was taken and\nreplaced with the {STR_VAR_1}.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnHoldingItemCantHoldMail[] = _("Este POKeMON ja segura um\nitem. Nao pode levar CARTA.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TeachWhichPokemon2[] = _("Ensinar qual POKeMON?"); // Unused
const u8 gText_ChoosePokemon[] = _("Escolha um POKeMON.");
const u8 gText_MoveToWhere[] = _("Mover para onde?");
const u8 gText_TeachWhichPokemon[] = _("Ensinar qual POKeMON?");
const u8 gText_UseOnWhichPokemon[] = _("Usar em qual POKeMON?");
const u8 gText_GiveToWhichPokemon[] = _("Dar a qual POKeMON?");
...
const u8 gText_NoPokemonForBattle[] = _("Sem POKeMON para lutar!");
const u8 gText_ChoosePokemon2[] = _("Escolha um POKeMON.");
const u8 gText_NotEnoughHp[] = _("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _("Precisa de {STR_VAR_1} POKeMON.");
...
const u8 gText_ChoosePokemonCancel[] = _("Escolha POKeMON ou CANCELAR.");
const u8 gText_ChoosePokemonConfirm[] = _("Escolha POKeMON e confirme.");
const u8 gText_SendWhichMonToPC[] = _("Enviar qual POKeMON ao PC?");
...
const u8 gText_CancelParticipation[] = _("Cancelar participacao?");
...
const u8 gText_RentalPkmn[] = _("POKeMON DE ALUGUEL");
...
const u8 gText_PkmnInfo[] = _("INFO POKeMON");
const u8 gText_PkmnSkills[] = _("HABILID. POKeMON");
const u8 gText_BattleMoves[] = _("GOLPES DE LUTA");
const u8 gText_ContestMoves[] = _("GOLPES CONCURSO");
...
const u8 gText_OddEggFoundByCouple[] = _("Um OVO POKeMON estranho\nachado na CRECHE.");
const u8 gText_PeculiarEggNicePlace[] = _("Um OVO POKeMON peculiar\nobtido no lugar legal.");
const u8 gText_PeculiarEggTrade[] = _("Um OVO POKeMON peculiar\nobtido em uma troca.");
const u8 gText_EggFromHotSprings[] = _("Um OVO POKeMON obtido\nnas aguas termais.");
const u8 gText_EggFromTraveler[] = _("Um OVO POKeMON estranho\nobtido de um viajante.");
...
const u8 gText_Toss2[] = _("JOGAR FORA");
...
const u8 gText_CancelDecorating[] = _("Cancelar decoracao?");
...
const u8 gText_No[] = _("NAO");
const u8 gText_Lv50[] = _("NV. 50");
const u8 gText_OpenLevel[] = _("NV. ABERTO");
...
const u8 gText_BattleFrontier[] = _("FRONTEIRA BATALHA");
...
const u8 gText_Cool2[] = _("LEGAL");
const u8 gText_Beauty2[] = _("BELEZA");
const u8 gText_Cute2[] = _("FOFO");
const u8 gText_Smart2[] = _("ESPERTO");
const u8 gText_Tough2[] = _("FORTE");
const u8 gText_Items[] = _("ITENS");
const u8 gText_Key_Items[] = _("ITENS CHAVE");
const u8 gText_Poke_Balls[] = _("POKeBOLAS");
const u8 gText_TMs_Hms[] = _("TMs e HMs");
const u8 gText_Berries2[] = _("BAGAS");
...
const u8 gText_MenuOptionOption[] = _("OPCOES");
...
const u8 gText_Single[] = _("UNICA");
const u8 gText_Double[] = _("DUPLA");
...
const u8 gText_BattleTower[] = _("TORRE BATALHA");
...
const u8 gText_BattleTower2[] = _("TORRE BATALHA");
const u8 gText_BattleDome[] = _("DOMO BATALHA");
const u8 gText_BattlePalace[] = _("PALACIO BATALHA");
const u8 gText_BattleFactory[] = _("FABRICA BATALHA");
const u8 gText_BattleArena[] = _("ARENA BATALHA");
const u8 gText_BattlePike[] = _("SERPENTE BATALHA");
const u8 gText_BattlePyramid[] = _("PIRAMIDE BATALHA");
...
const u8 gText_BattleTower3[] = _("TORRE BATALHA");
const u8 gText_BattleDome2[] = _("DOMO BATALHA");
const u8 gText_BattlePalace2[] = _("PALACIO BATALHA");
const u8 gText_BattleArena2[] = _("ARENA BATALHA");
const u8 gText_BattleFactory2[] = _("FABRICA BATALHA");
const u8 gText_BattlePike2[] = _("SERPENTE BATALHA");
const u8 gText_BattlePyramid2[] = _("PIRAMIDE BATALHA");
...
const u8 gText_WinStreak[] = _("Vitorias: {STR_VAR_1}");
...
ALIGNED(4) const u8 gText_RecordsOpenLevel[] = _("NV. ABERTO");
...
const u8 gText_MenuOption[] = _("OPCOES");
...
const u8 gText_RentalPkmn2[] = _("POKeMON DE ALUGUEL");
...
ALIGNED(4) const u8 gText_Toss[] = _("JOGAR FORA");
...
const u8 gText_MoveRelearnerPkmnLearnedMove[] = _("{STR_VAR_1} aprendeu\n{STR_VAR_2}!");
...
const u8 gText_MoveRelearnerBattleMoves[] = _("GOLPES DE LUTA");
const u8 gText_MoveRelearnerContestMovesTitle[] = _("GOLPES CONCURSO");
...
const u8 gText_PokeBalls[] = _("POKeBOLAS");
const u8 gText_Berry[] = _("BERRY");
const u8 gText_Berries[] = _("BAGAS");
