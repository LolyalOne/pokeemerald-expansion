...
static const u8 sText_PlayerDefeatedLinkTrainerTrainer1[] = _("Voce venceu {B_TRAINER1_NAME_WITH_CLASS}!");
static const u8 sText_OpponentMon1Appeared[] = _("{B_OPPONENT_MON1_NAME} apareceu!");
static const u8 sText_WildPkmnAppeared[] = _("Um {B_OPPONENT_MON1_NAME} selvagem apareceu!");
static const u8 sText_LegendaryPkmnAppeared[] = _("Um {B_OPPONENT_MON1_NAME} selvagem apareceu!");
...
static const u8 sText_Trainer1WantsToBattle[] = _("Voce foi desafiado por {B_TRAINER1_NAME_WITH_CLASS}!");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNGREWTOLV]                         = COMPOUND_STRING("{B_BUFF1} subiu para o NV. {B_BUFF2}!\p"),
    [STRINGID_PKMNLEARNEDMOVE]                      = COMPOUND_STRING("{B_BUFF1} aprendeu {B_BUFF2}!\p"),
    ...
    [STRINGID_PKMNFELLASLEEP]                       = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} dormiu!"),
    ...
    [STRINGID_PKMNWASBURNED]                        = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} sofreu queimadura!"),
    ...
    [STRINGID_CRITICALHIT]                          = COMPOUND_STRING("Um golpe critico!"),
    ...
    [STRINGID_STARTEDTORAIN]                        = COMPOUND_STRING("Comecou a chover!"),
    ...
    [STRINGID_SANDSTORMBREWED]                      = COMPOUND_STRING("Uma tempestade de areia comecou!"),
    ...
    [STRINGID_SUNLIGHTGOTBRIGHT]                    = COMPOUND_STRING("O sol ficou muito forte!"),
    ...
    [STRINGID_ITDODGEDBALL]                         = COMPOUND_STRING("It dodged your thrown Poké Ball! This POKeMON can't be caught!"),
    [STRINGID_PKMNBROKEFREE]                        = COMPOUND_STRING("Oh no! The POKeMON broke free!"),
    [STRINGID_ITAPPEAREDCAUGHT]                     = COMPOUND_STRING("Ahhh! Quase pegou!"),
    ...
    [STRINGID_GIVENICKNAMECAPTURED]                 = COMPOUND_STRING("Quer dar um apelido para {B_DEF_NAME}?"),
    ...
    [STRINGID_ENEMYABOUTTOSWITCHPKMN]               = COMPOUND_STRING("{B_TRAINER1_NAME_WITH_CLASS} is about to send out {B_BUFF2}.\pWill you switch your POKeMON?"),
    ...
    [STRINGID_ASANDSTORMKICKEDUP]                   = COMPOUND_STRING("Uma tempestade de areia comecou!"),
    [STRINGID_PKMNSWILLPERISHIN3TURNS]              = COMPOUND_STRING("Both POKeMON will perish in three turns!"),  //don't think this message is displayed anymore
    ...
    [STRINGID_TEAMTRAPPEDWITHVINES]                 = COMPOUND_STRING("{B_DEF_TEAM1} POKeMON got trapped with vines!"),
    [STRINGID_PKMNHURTBYVINES]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by G-Max Vine Lash's ferocious beating!"),
    [STRINGID_TEAMCAUGHTINVORTEX]                   = COMPOUND_STRING("{B_DEF_TEAM1} POKeMON got caught in a vortex of water!"),
    [STRINGID_PKMNHURTBYVORTEX]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by G-Max Cannonade's vortex!"),
    [STRINGID_TEAMSURROUNDEDBYFIRE]                 = COMPOUND_STRING("{B_DEF_TEAM1} POKeMON were surrounded by fire!"),
    [STRINGID_PKMNBURNINGUP]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is burning up within G-Max Wildfire's flames!"),
    [STRINGID_TEAMSURROUNDEDBYROCKS]                = COMPOUND_STRING("{B_DEF_TEAM1} POKeMON became surrounded by rocks!"),
